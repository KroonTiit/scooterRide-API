...
public class ReservationService {
   ...
   private Double calculateCost(LocalDateTime startTime, LocalDateTime endTime) {
    ...
    // Calculate cost for the remaining minutes after the first 10 minutes (0.3€ per minute)
    if (totalMinutes > 10) {
        long extraMinutes = totalMinutes - 10;
        cost += extraMinutes * 0.3;
    }

    // Account for any remaining seconds beyond the last full minute as an extra minute
